...
const SignUp = () => {
	...
	return (
		<ScrollView className="h-screen flex-1 bg-primary">
			<View className="h-full py-14 px-8 flex-1 flex-col items-center">
				...
				<View className="w-full flex-1 pt-8 justify-end">
					<Pressable
